...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // '/api/auth': {
      //   // target: 'http://192.168.140.2:8600/',
      //   target: 'http://192.168.110.165:8601',
      //   changeOrigin: true,
      //   secure: false,
      ...
      // '/api/user': {
      //   target: 'http://192.168.140.2:8600/',
      //   // target: 'http://192.168.110.165:8600',
      //   changeOrigin: true,
      //   secure: false,
      //   rewrite: (path) => path.replace('/api', '')
      // },
      ...
      // },
      // '/api/tools': {
      //   target: 'http://127.0.0.1:8608/',
      //   // target: 'http://192.168.0.100:8699',
      //   changeOrigin: true,
      //   secure: false,
      //   rewrite: (path) => path.replace('/api', '')
      // },
      '/api/skieernlpweb': {
        ...
        target: 'http://192.168.120.24:8087',
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace('/api/', '')
      },
      ...
      //   target: 'http://192.168.0.100:8086',
      //   changeOrigin: true,
      //   secure: false
      //   // rewrite: (path) => path.replace('/api/', '')
      // }
