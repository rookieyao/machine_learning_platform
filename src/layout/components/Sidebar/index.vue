<template>
  <div :class="{ 'has-logo': showLogo }">
    ...
    <el-scrollbar wrap-class="scrollbar-wrapper">
      <el-menu :router="true" :unique-opened="false" :default-active="activeMenu" class="el-menu-vertical" :collapse="isCollapse" @select="selectMenu" background-color="#545c64" text-color="#fff">
        <!--递归路由对象-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectMenu = (index, indexPath) => {
      logInfo('select', index, indexPath)
    }
