      ...
      <div class="right-menu">
        ...
        <!-- <el-button id="fullScreen" class="full-screen">
          <el-tooltip :content="langConfig.header.fullScreen[lang]" effect="dark" placement="left">
            <i v-show="fullScreen == false" class="el-icon-full-screen" @click="toShowFullScreen()">
              <el-icon>
                <fullScreen></fullScreen> </el-icon
            ></i>
          </el-tooltip>
          <el-tooltip :content="langConfig.header.exitFullScreen[lang]" effect="dark" placement="left">
            ...
            <el-icon class="full-screen-icon" v-show="fullScreen == true" @click="toExitFullScreen()">
...
import Service from '@/views/Login/api'
...
export default defineComponent({
  ...
  setup() {
    ...
    const opened = computed(() => store.getters['appModule/getSidebarState']) // Hamburger 箭头方向
    const fullScreen = ref(false)
    const lang = computed((): string => store.getters['settingsModule/getLangState'])
    const nickname = computed(() => localStorage.getItem('username') ?? '??')
